      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        <div className="admin-card overflow-hidden">
          <table className="w-full">
            ...
            <tbody>
              {isLoading ? (
                <tr><td colSpan={5}><LoadingTable cols={5} rows={8} /></td></tr>
              ) : customers.length === 0 ? (
                <tr>
                ...
                >
                  ...
                  <td className="table-cell hidden md:table-cell">
                    <div className="space-y-0.5">
                      ...
                      <div className="flex items-center gap-1.5 text-xs text-slate-500"><Phone size={11} />{c.mobileNumber ?? '—'}</div>
                    </div>
                  </td>
                  <td className="table-cell hidden lg:table-cell">
                    <p className="text-sm text-slate-700 dark:text-slate-300">{c.tenant?.laundryName ?? '—'}</p>
