              ...
              {isLoading ? (
                ...
                <tr key={t._id} className="table-row">
                  <td className="table-cell">
                    <p className="text-sm font-medium text-slate-800 dark:text-slate-100">{t.shopName}</p>
                  </td>
                  <td className="table-cell hidden md:table-cell text-sm text-slate-500">{t.owner?.name ?? '—'}</td>
                  <td className="table-cell">
