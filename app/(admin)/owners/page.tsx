              ...
              {isLoading ? (
                ...
                <tr key={owner._id} className="table-row">
                  ...
                  <td className="table-cell hidden md:table-cell">
                    <p className="text-sm text-slate-700 dark:text-slate-300">{owner.tenant?.shopName ?? '—'}</p>
                    <p className="text-xs font-mono text-cyan-500/70">{owner.tenant?.tenantCode ?? '—'}</p>
                  </td>
